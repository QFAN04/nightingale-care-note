...
from app.models.timeline import ConsultSession, InteractionType, ProcessingStatus
...
async def run_patient_scribe(
    ...
    allowed_interaction = ALLOWED_INTERACTION_BY_ROLE.get(user.role)
